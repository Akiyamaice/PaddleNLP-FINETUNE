...
作者：新疆大学-王超 邮箱：akiyamaice@163.com

PaddleNLP是一款基于飞桨深度学习框架的大语言模型(LLM)开发套件，支持在多种硬件上进行高效的大模型训练、无损压缩以及高性能推理。PaddleNLP 具备简单易用和性能极致的特点，致力于助力开发者实现高效的大模型产业级应用。

![img](https://geektechstudio.feishu.cn/space/api/box/stream/download/asynccode/?code=Mzk1ZjJiNDUzM2ZmYmY1ZTlkNTdmNmJkMThjOTU0MDRfeURjUm1xbkVENERnemczb0hYNUc1djdQVllGUzkxTkdfVG9rZW46VVNId2JjemZpb3N6VHV4aFRoaGNnajZTbmFjXzE3NDg0MTMwNjU6MTc0ODQxNjY2NV9WNA)
...
![image-20250528160518297](C:\Users\Aisa\AppData\Roaming\Typora\typora-user-images\image-20250528160518297.png)
...
此外，您也可以尝试使用回调函数来使用swanlab,下面是主要代码：
...
上面的代码参考PaddleNLP提供的微调代码并进行修改，其他相关的代码可以在PaddleNLP的项目中找到。
...
![image-20250528210949379](C:\Users\Aisa\AppData\Roaming\Typora\typora-user-images\image-20250528210949379.png)

至此，使用PaddleNLP进行大模型的微调已经完成。

### 相关链接

- 代码：[Github](https://github.com/Zeyi-Lin/Qwen3-Medical-SFT)
